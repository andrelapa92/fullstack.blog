...
import fullstack.blog.services.ComentarioService;
...
public class ComentarioController {
    ...
    public ResponseEntity <Comentario> save (@RequestBody Comentario comentario) {
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentContextPath().path("comentarios/{id}").buildAndExpand(savedComentario.getId()).toUri();
